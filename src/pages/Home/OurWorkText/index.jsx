    ...
    <div className="w-[1000px] pr-40">
      ...
      <div className="text-sm drop-shadow-[0px_4px_4px_rgba(0,0,0,0.25)]">
        <p className="mb-2 text-justify">
          ...
          dan Fabrication. Dengan fokus utama ada pada Jasa Machining/Pemesinan.
          Selain bidang jasa kami juga menjual produk-produk jadi dalam untuk
          indusri karet, dan stone crusher. Untuk lebih jelas silahkan lihat
          portofolio kami dalam website ini atau kontak kami secara langsung.
        </p>
      </div>
    </div>
  );
